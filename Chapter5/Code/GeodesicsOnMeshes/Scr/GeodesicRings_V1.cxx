...
//-----------------------------------------------Geodesic Contours Extraction--------------------------------------------------------
  ...
  cutter->SetValue(6, 3.5*atof(argv[3]));
  cutter->Update();
  ...
  std::string ResultFileName = Prefix + "_" + argv[1] + "_cutter.vtk";
  // Write Results
  ...
  vtkSmartPointer<vtkIdList> idList_unsorted = vtkSmartPointer<vtkIdList>::New();
 ...
 for(int Line_ID = 0;  Line_ID < ContoursDividedPolyData->GetNumberOfLines(); Line_ID++)
  {
      ContoursDividedPolyData->GetLines()->GetNextCell(idList_unsorted);
      vtkSmartPointer<vtkIdList> idList = vtkSmartPointer<vtkIdList>::New();
      //idList = FixPointsOrder(idList_unsorted,ContoursDividedPolyData);
      idList = idList_unsorted;
