...
if LH:
	...
	os.system('../Code/joohwi/klaplace-build/klaplace -dims 300 ' + str(ID) + '_LH_MID.vtk '  + str(ID) + '_LH_GM_Outer_MC.vtk  -surfaceCorrespondence ' + str(ID) + '_LH_Outer.corr')

	subprocess.call('Establishing Streamlines', shell=True)

	os.system('../Code/joohwi/klaplace-build/klaplace -traceStream ' + str(ID) +  '_LH_Outer.corr_field.vts ' + str(ID) + '_LH_MID.vtk ' + str(ID) + '_LH_GM_Outer_MC.vtk ' + str(ID) + '_LH_Outer_streamlines.vtp ' + str(ID) + '_LH_Outer_points.vtp -traceDirection forward')

	os.system('../Code/joohwi/klaplace-build/klaplace -conv ' + str(ID) + '_LH_Outer_streamlines.vtp ' + str(ID) + '_LH_Outer_streamlines.vtk')

	subprocess.call('echo Computing LH EACSF', shell=True)

	os.system('../Code/Estimate1DCortexStreamlinesDensity/build/EstimateCortexStreamlinesDensity ' + str(ID) + '_LH_MID.vtk ' + str(ID) + '_LH_Outer_streamlines.vtk ' + str(ID) + '_CSF_Prop_Masked.nrrd ' + str(ID) + '_LH_GM_Dilated.nrrd ' + str(ID) + '_LH_CSF_Density.vtk ' + str(ID) + '_LH_Visitation.nrrd 0 0 0')
	...
	os.system('../Code/Estimate1DCortexStreamlinesDensity/build/EstimateCortexStreamlinesDensity ' + str(ID) + '_LH_MID.vtk ' + str(ID) + '_LH_Outer_streamlines.vtk ' + str(ID) + '_CSF_Prop_Masked_EA.nrrd ' + str(ID) + '_LH_GM_Dilated.nrrd ' + str(ID) + '_LH_CSF_Density.vtk ' + str(ID) + '_LH_Visitation.nrrd 0 0 0')
...
if RH:
	...
	os.system('../Code/joohwi/klaplace-build/klaplace -dims 300 ' + str(ID) + '_RH_MID.vtk '  + str(ID) + '_RH_GM_Outer_MC.vtk  -surfaceCorrespondence ' + str(ID) + '_RH_Outer.corr')

	subprocess.call('Establishing Streamlines', shell=True)

	os.system('../Code/joohwi/klaplace-build/klaplace -traceStream ' + str(ID) +  '_RH_Outer.corr_field.vts ' + str(ID) + '_RH_MID.vtk ' + str(ID) + '_RH_GM_Outer_MC.vtk ' + str(ID) + '_RH_Outer_streamlines.vtp ' + str(ID) + '_RH_Outer_points.vtp -traceDirection forward')

	os.system('../Code/joohwi/klaplace-build/klaplace -conv ' + str(ID) + '_RH_Outer_streamlines.vtp ' + str(ID) + '_RH_Outer_streamlines.vtk')

	subprocess.call('echo Computing RH EACSF', shell=True)

	os.system('../Code/Estimate1DCortexStreamlinesDensity/build/EstimateCortexStreamlinesDensity ' + str(ID) + '_RH_MID.vtk ' + str(ID) + '_RH_Outer_streamlines.vtk ' + str(ID) + '_CSF_Prop_Masked.nrrd ' + str(ID) + '_RH_GM_Dilated.nrrd ' + str(ID) + '_RH_CSF_Density.vtk ' + str(ID) + '_RH_Visitation.nrrd 0 0 0')
	...
	os.system('../Code/Estimate1DCortexStreamlinesDensity/build/EstimateCortexStreamlinesDensity ' + str(ID) + '_RH_MID.vtk ' + str(ID) + '_RH_Outer_streamlines.vtk ' + str(ID) + '_CSF_Prop_Masked_EA.nrrd ' + str(ID) + '_RH_GM_Dilated.nrrd ' + str(ID) + '_RH_CSF_Density.vtk ' + str(ID) + '_RH_Visitation.nrrd 0 0 0')
